...
async function createTestPenalty() {
  try {
    ...
    // Calculate penalty for 30 minutes late
    const lateMinutes = 30;
    const hourlyRate = salary.base_salary / salary.work_hours_per_month;
    const penaltyAmount = Math.round(hourlyRate * (lateMinutes / 60));
    ...
    const penalty = await Penalty.create({
      ...
      reason: `Kechikish: ${lateMinutes} daqiqa (09:00 o'rniga 09:30 da keldi)`,
      penalty_type: 'late',
