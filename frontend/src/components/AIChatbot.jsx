    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 bg-gradient-to-r from-green-500 to-purple-600 text-white rounded-full p-3 sm:p-4 shadow-2xl hover:scale-110 transition-transform duration-300 animate-bounce"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed inset-x-0 bottom-0 sm:bottom-6 sm:right-6 sm:left-auto z-50 w-full sm:w-96 h-[100dvh] sm:h-[600px] bg-white dark:bg-gray-800 sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden border-t sm:border border-gray-200 dark:border-gray-700">
          {/* Header */}
          <div className="bg-gradient-to-r from-green-500 to-purple-600 text-white p-3 sm:p-4 flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h3 className="font-bold text-sm sm:text-base">AI Yordamchi</h3>
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 bg-gray-50 dark:bg-gray-900">
            {messages.map((msg, index) => (
              ...
              >
                ...
                >
                  ...
                  <p className={`text-[10px] sm:text-xs mt-1 ${msg.role === 'user' ? 'text-white/70' : 'text-gray-500'}`}>
            ...
            {isTyping && typingMessage && (
              <div className="flex justify-start animate-fadeIn">
                <div className="max-w-[85%] sm:max-w-[80%] bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-2xl px-3 py-2 sm:px-4 sm:py-3 shadow-md">
                  <p className="text-xs sm:text-sm whitespace-pre-wrap break-words">{typingMessage}<span className="animate-pulse">|</span></p>
                </div>
              </div>
            )}
            ...
            {isLoading && !isTyping && (
              <div className="flex justify-start">
                <div className="bg-white dark:bg-gray-800 rounded-2xl px-3 py-2 sm:px-4 sm:py-3 shadow-md">
          ...
          {/* Input */}
          <div className="p-3 sm:p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 safe-area-bottom">
            <div className="flex gap-2">
              <textarea
                ...
                className="flex-1 px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:outline-none resize-none bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 text-sm"
                rows="2"
              ...
              <button
                ...
                className="px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-500 to-purple-600 text-white rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
