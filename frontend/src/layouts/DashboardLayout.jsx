          ...
          <div className="flex-1 max-w-xl ml-4 lg:ml-0">
            <div className="relative group hidden sm:block">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm"
              />
            </div>
          </div>
